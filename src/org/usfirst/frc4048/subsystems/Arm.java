...
//	private final AnalogPotentiometer extensionPot = RobotMap.armextensionPot;
	...
	private final double EXT_STALL_DELAY = 5.0;
	private double startStallTime = -EXT_STALL_DELAY;
	...
	public static final double INTAKE_SETPOINT = 16.5;
...
//	private boolean autoExt = false;
    ...
    public final Logging.LoggingContext loggingContext = new Logging.LoggingContext(Logging.Subsystems.ARM) {
		...
		protected void addAll() {
			...
			add("Ext I", extI);
			add("Ext D", extD);
			add("Extension Retract Switch", extensionMotor.getSensorCollection().isFwdLimitSwitchClosed());
		}
