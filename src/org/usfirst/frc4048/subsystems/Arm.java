...
public class Arm extends Subsystem {
    ...
    private boolean movingToPos = false;	//Shows if the MoveArm command is being called, preventing fine tuning
...
//			return armPos >= HOME_SETPOINT - RANGE_VALUE && armPos <= HOME_SETPOINT + RANGE_VALUE;
    ...
    /**
     * States if the arm is attempting to move to a defined state
     * @param value
     */
    public void setMovingToPos(boolean value)
    {
    	movingToPos = value;
    }
