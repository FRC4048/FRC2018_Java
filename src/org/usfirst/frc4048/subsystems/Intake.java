...
//    }
    ...
    public void flushCube()
    {
    	if(Robot.arm.armAtPosition(ArmPositions.Switch) || Robot.arm.armAtPosition(ArmPositions.Intake) || Robot.arm.armAtPosition(ArmPositions.Exchange)) {
    		leftIntakeMotor.set(-ROLLER_SPEED_FLUSH);
    		rightIntakeMotor.set(-ROLLER_SPEED_FLUSH);
    	}
    	else {
    		leftIntakeMotor.set(-ROLLER_SPEED_FLUSH_FASTER);
    		rightIntakeMotor.set(-ROLLER_SPEED_FLUSH_FASTER);
    	}
    }
