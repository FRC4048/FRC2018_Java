...
public class Claw extends Subsystem {
    ...
    private final double LEVEL_MAX_SPEED = 0.5*Robot.GLOBAL_SCALE_FACTOR;
	private final double LEVEL_MIN_SPEED = 0.1*Robot.GLOBAL_SCALE_FACTOR;
...
//    private final AnalogInput pressureSensor = RobotMap.clawpressureSensor;
    ...
    private final double ANGLE_UP_SPEED = 0.4*Robot.GLOBAL_SCALE_FACTOR;
    private final double ANGLE_DOWN_SPEED = -0.3*Robot.GLOBAL_SCALE_FACTOR;
