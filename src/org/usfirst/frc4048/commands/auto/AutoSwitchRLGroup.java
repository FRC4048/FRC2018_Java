 ...
 *
 */
public class AutoSwitchRLGroup extends CommandGroup {

    public AutoSwitchRLGroup() {
        // Add Commands here:
        ...
        // arm.
    	addParallel(new DriveDistance(AutoAction.LOCAL_SWITCH_DISTANCE, AutoAction.LOCAL_SCALE_SPEED,0,0));
