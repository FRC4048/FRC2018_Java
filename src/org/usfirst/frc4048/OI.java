...
public class OI {
    ...
    public final IntakeCubeTriggerLeft intakeCubeTriggerLeft;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        intakeCubeTriggerRight.whenActive(new IntakeCube(IntakeMode.STRAIGHT_PULL));
        
        intakeCubeTriggerLeft = new IntakeCubeTriggerLeft(xboxController);
        intakeCubeTriggerLeft.whenActive(new IntakeCube(IntakeMode.TOGGLE_PULL_LEFT_OR_RIGHT));
