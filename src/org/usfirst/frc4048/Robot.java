...
public class Robot extends TimedRobot {
	...
	SendableChooser<Boolean> speedLimitChooser = new SendableChooser<>();
	...
	public static boolean enableSpeedLimit = false;
	...
	public void robotInit() {
		...
		speedLimitChooser.addDefault("Disable Speed Limit", false);
		speedLimitChooser.addObject("Enable Speed Limit", true);
...
//		dashboardData();
	...
	public void disabledPeriodic() {
		...
		enableSpeedLimit = speedLimitChooser.getSelected();
		dashboardData();
	}
...
//		dashboardData();
		...
		autoAction = chooser.getSelected();
		enableSpeedLimit = speedLimitChooser.getSelected();
		SmartDashboard.putBoolean("speedLimitChooserValue", speedLimitChooser.getSelected());
		if (autonomousCommand != null)
...
//			// SmartDashboard.putBoolean("Intake Has Cube", intake.hasCube());
		...
		SmartDashboard.putData("Speed Limit", speedLimitChooser);
